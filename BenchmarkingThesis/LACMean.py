# -*- coding: utf-8 -*-
"""
Created on Fri Jul 4 11:22:01 2021
...
file1 = datapath_head + "/processed/segmentedART9/" + 'labels_mean.txt'
...
file2 = datapath_head + "/processed/segmentedART74/" + 'labels_mean.txt'
...
data_file1 = datapath_head + "/processed/segmentedART9/" + 'LAC_mean.csv'
...
data_file2 = datapath_head + "/processed/segmentedART74/" + 'LAC_mean.csv'
...
for seg_id in itertools.islice(itertools.count(), 0, len(unique_numbers1)):
    ...
    idx1_1 = X1_np[list(idx1[0]), :].transpose()
    print(max(list(idx1_1)))
    print(idx1_1.mean())
    plt.plot(x_1, idx1_1)
    #plt.show()
...
for seg_id in itertools.islice(itertools.count(), 0, len(unique_numbers2)):
    ...
    idx2_2 = X2_np[list(idx2[0]), :].transpose()
    print(max(list(idx2_2)))
    print(idx2_2.mean())
    plt.plot(x_2, idx2_2)
    #plt.show()